...
const nameifl = 'VLESS-IFLIX';
const nameedu = 'VLESS-ISAT-EDU';
const nameilped = 'VLESS-TSEL-ILPED';
...
//BIZ   
     const commonUrlBiz = `:443?encryption=none&security=tls&sni=${bugbiz}.${hostName}&fp=randomized&type=ws&host=${bugbiz}.${hostName}&path=%2Fvless-bodong#${namebiz}`;
	const commonUrlBizz = `:80?encryption=none&security=none&type=ws&host=${bugbiz}.${hostName}&path=%2Fvless-bodong#${namebiz}`;
//XCL+Addon
    const commonUrlXcl = `:443?encryption=none&security=tls&sni=${bugxcl}.${hostName}&fp=randomized&type=ws&host=${bugxcl}.${hostName}&path=%2Fvless-bodong#${namexcl}`;
	const commonUrlXcll = `:80?encryption=none&security=none&type=ws&host=${bugxcl}.${hostName}&path=%2Fvless-bodong#${namexcl}`;
//XCL No Addon
    const commonUrlXcln = `:443?encryption=none&security=tls&sni=${bugxcln}.${hostName}&fp=randomized&type=ws&host=${bugxcln}.${hostName}&path=%2Fvless-bodong#${namexcl}`;
	const commonUrlXclln = `:80?encryption=none&security=none&type=ws&host=${bugxcl}.${hostName}&path=%2Fvless-bodong#${namexcl}`;
//NETFLIX
...
// SETTINGAN BIZ
    ...
    tls: true
    skip-cert-verify: true
    servername: ${bugbiz}.${hostName}
    network: ws
    ws-opts:
      path: /vless-bodong
      headers:
        Host: ${bugbiz}.${hostName}
    udp: true`;
...
// SETTINGAN XCL
    ...
    tls: true
    skip-cert-verify: true
    servername: ${bugxcl}.${hostName}
    network: ws
    ws-opts:
      path: /vless-bodong
      headers:
        Host: ${bugxcl}.${hostName}
    udp: true`;
...
// SETTINGAN XCL No Addon
    ...
    tls: true
    skip-cert-verify: true
    servername: ${bugxcln}.${hostName}
    network: ws
    ws-opts:
      path: /vless-bodong
      headers:
        Host: ${bugxcln}.${hostName}
    udp: true`;
...
===========================================
${vlessxcln}
<button onclick='copyToClipboard("${vlessxcln}")'><i class="fa fa-clipboard"></i> Copy vless 443</button>
===========================================
× Vless port 80
===========================================
${vlessxclln}
<button onclick='copyToClipboard("${vlessxclln}")'><i class="fa fa-clipboard"></i> Copy vless 80</button>
===========================================
× Config Openclash
===========================================
${opclashxcln}
...
===========================================
${vlessifl}
<button onclick='copyToClipboard("${vlessifl}")'><i class="fa fa-clipboard"></i> Copy vless 443</button>
===========================================
× Vless port 80
===========================================
${vlessifll}
<button onclick='copyToClipboard("${vlessifll}")'><i class="fa fa-clipboard"></i> Copy vless 80</button>
===========================================
× Config Openclash
===========================================
${opclashifl}
...
<div hidden id="codeedu">
  - name: ${nameedu}
    ...
    ws-opts:
      ...
      headers:
        Host: ${bugedu}.${hostName}
    udp: true  </div> </div> <center> <button class="button" onclick="showText('cfgvid')">Vless Vidio</button><br>
...
`;
  ...
  <head>
	...
	<meta name='description' content='Vless ini gratis silahkan pakai sampai down.'>
	<meta name='keywords' content='Vless Bodong, cloudflare pages, cloudflare worker, severless'>
	    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta property='og:site_name' content='VLESS CF FREE By Bodong.' />
	<meta property='og:type' content='website' />
	<meta property='og:title' content='Jika ingin share tambahkan credit telegram saya!' />
	<meta property='og:description' content='Vless ini gratis silahkan pakai sampai down.' />
	<meta property='og:url' content='https://${hostName}/' />
	<meta property='og:image' content='https://telegra.ph/file/58681d5a5bc1503dbaf83.jpg' />
	<meta name='twitter:card' content='summary_large_image' />
	<meta name='twitter:title' content='Jika ingin share tambahkan credit telegram saya!' />
	<meta name='twitter:description' content='Vless ini gratis silahkan pakai sampai down.' />
	<meta name='twitter:url' content='https://${hostName}/' />
	<meta name='twitter:image' content='https://telegra.ph/file/58681d5a5bc1503dbaf83.jpg' />
